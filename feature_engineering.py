...
=====================
Engineers predictive features from merged IMD climate data.
...
def engineer_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    required_cols = {"lat", "lon", "day_of_year", "tmax", "tmin", "rainfall"}
...
def dataset_to_dataframe(ds) -> pd.DataFrame:
    ...
    climate_vars = [c for c in ["tmax", "tmin", "rainfall"] if c in df.columns]
...
if __name__ == "__main__":
    ...
    INPUT  = "data/merged_climate_2023.nc"
    OUTPUT = "data/features_2023.csv"
    ...
    # ── Summary statistics ────────────────────────────────────────────
    feature_cols = ["rainfall_7d", "dtr", "rainfall_lag1", "tmax_lag1"]
    print("\n--- Feature Statistics ---")
